...
Add the below code inside 'initSockJS' method in `sockJSServer.js' file
...
```
Below is the implementation of the above method. Add these methods outside 'initSockJS' method in `sockJSServer.js`
