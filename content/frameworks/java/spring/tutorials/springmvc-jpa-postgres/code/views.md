Add the following jsp file as `login.jsp`
...
```
Add the following jsp file as `expenseapproval.jsp`
    ...
    <c:if test="${fn:length(approvedExpenseList) gt 0 }">
        <table id="table-a" class="table-a mtop80">
            ...
            <tr class="tr-odd">
                ...
                <td>
                    <h5 class="label-4">
                    ${expense.id}<img class="clip-b-img"
                ...
                <td>
                    ...
                    <form:form name="actionForm" id="actionForm" method="put">
                        <select id="action_${rowCounter.count}"
                            ...
                            onchange="changeState('${pageContext.request.contextPath}','${expense.id}','${rowCounter.count}')">
                    ...
                    <i class="alt-b label-6"> <img class="right-b-img"
                        src="<c:url value="/resources/images/cross-a.png" />">
                        Rejected <a
                        href="${pageContext.request.contextPath}/expensereports/${expense.id}"
...
```
Add the following jsp file as `myexpense.jsp`
    ...
    <table  id="table-a" class="table-a mtop80">
        ...
        <c:forEach var="expense" items="${pendingExpenseList}">
            ...
            <c:if test="${not empty expense.attachment.fileName}">
             <a href="${pageContext.request.contextPath}/attachments/${expense.attachment.id}"><img class="clip-b-img" src="<c:url value="/resources/images/clip-b.png" />"></a>
            </c:if>
            </td>
            <td>
            <h5 class="label-4">${expense.expenseDate}</h5>
            ...
            <h5 class="label-4">
                ...
                <i class="alt-b label-6">
                    ...
                    <a href="${pageContext.request.contextPath}/expensereports/${expense.id}" class="bg-edit-b">
                     ...
                     <form:form id="deleteform1" name="deleteform1" method="delete" class="bg-cross-b">
                       <a onclick="deleteexpense('${pageContext.request.contextPath}',1,'${expense.id}')">
                ...
                <i class="alt-b label-6">
                    ...
                    <a  onclick="deleteexpense('${pageContext.request.contextPath}',2,'${expense.id}')">
                      <img class="cross-b-img" src="<c:url value="/resources/images/cross-b.png" />"> </a>
                    </form:form>
                </i>
                </c:if>
                ...
                <i class="alt-b label-6">
                    ...
                    <a href="${pageContext.request.contextPath}/expensereports/${expense.id}" class="bg-edit-b">
                     ...
                     <form:form id="deleteform3" name="deleteform3" method="delete" class="bg-cross-b">
                      <a  onclick="deleteexpense('${pageContext.request.contextPath}',3,'${expense.id}')">
                       <img class="cross-b-img" src="<c:url value="/resources/images/cross-b.png" />" > </a>
                     </form:form>
                </i>
                </c:if>
...
```
Add the following jsp file as `newexpense.jsp`
...
<body>
    ...
    <c:when test="${isEdit eq 'true'}">
        <div class="mc-a">
            <form:form action="${pageContext.request.contextPath}/expensereports/${expense.id}"
...
Add the following jsp file as `signup.jsp`
```jsp
<!DOCTYPE HTML>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<html>
