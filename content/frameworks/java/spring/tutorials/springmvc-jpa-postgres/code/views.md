            ...
            <c:forEach var="expense" items="${approvedExpenseList}"
                ...
                <td>
                    ...
                    <c:if test="${expense.state eq 'REJECTED' }">
                        ...
                        src="<c:url value="/resources/images/cross-a.png" />">
                        Rejected <a
                        href="${pageContext.request.contextPath}/deleteExpense?expenseId=${expense.id}"
...
<div id="contentWrapper">
 ...
 <div id="nav">
        ...
        <c:if test="${fn:length(pendingExpenseList) gt 0 }">
            ...
            <td>
                ...
                <i class="alt-b label-6">
                    ...
                    <a href="${pageContext.request.contextPath}/editExpense?expenseId=${expense.id}" class="bg-edit-b">
                         <img class="clip-b-img" src="<c:url value="/resources/images/edit-a.png" />"> </a>
                    <a href="${pageContext.request.contextPath}/deleteExpense?expenseId=${expense.id}" class="bg-cross-b">
    ...
    <div id="pager"  class="pagination pagination-1" style="align:center ">
