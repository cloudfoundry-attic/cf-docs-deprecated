---
title: Spring MVC ExpenseReport App Controllers Code
description: Spring MVC ExpenseReport App Controllers Code
tags:
    - spring
    - code
    - java
...
public class ExpenseController {
    ...
    public void updateExpense(@PathVariable("expenseId")Long expenseId, @RequestParam("description")String description
    ...
    public Long createNewExpense(@RequestParam("description")String description
        ...
        Expense expense = new Expense(description, expenseType, new Date(), amount, user);
