---
title: Controller for Expense Reporting App using Redis
description: Controller for Expense Reporting App using Redis
---
```java
...
public class ExpenseController {
    ...
    public void updateExpense(@PathVariable("expenseId") Long expenseId,
        ...
        ExpenseType expenseType = expenseTypeService.getExpenseTypeById(new Long(
                expenseTypeVal));
        Expense expense = expenseService.getExpense(expenseId);
