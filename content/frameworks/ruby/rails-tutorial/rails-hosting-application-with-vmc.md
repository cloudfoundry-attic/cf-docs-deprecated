...
This is the continuation for the previous [chapter](/frameworks/ruby/rails-tutorial/rails-expense-admin-flow.html). This section clearly explains how to host and manage the applications on Cloud Foundry using `vmc` a command line tool for hosting applications on Cloud Foundry.
...
Before pushing any Rails 3.1 applications or above, there is one thing to be done.

###Bundle Your packages.

Packages needs to be bundles before pushing the application to Cloud Foundry.
