...
This is the continuation for the previous [chapter](/frameworks/ruby/rails-tutorial/postgres/rails-expense-admin-flow.html). This section clearly explains hoe to host and manage the applications on Cloud Foundry using `vmc` a command line tool for hosting the applications on Cloud Foundry.

##Prerequisites

+ Should have completed [chapter 4](/frameworks/ruby/rails-tutorial/postgres/rails-expense-admin-flow.html) or must have an application that can push to Cloud Foundry.
