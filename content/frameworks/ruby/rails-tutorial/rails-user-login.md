...
Users can Sign up but can’t Signin yet. We will Fix that by creating a new controller called `sessions_controller` that will handle login and logout.
