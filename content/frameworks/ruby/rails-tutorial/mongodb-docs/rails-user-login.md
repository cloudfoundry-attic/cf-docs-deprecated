...
If you are starting this chapter from the downloaded source code [Exercise2-Starter.zip](/rails-code/expense-reporting-mongodb/Exercise2-Starter.zip), please setup the application as described [here](/frameworks/ruby/rails-tutorial/mongodb-docs/mongodb-starters-guide.html) before continue with this tutorial.
